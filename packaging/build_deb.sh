...
# dependency .debs from /prebuilt, then builds pairs_serial and copies the .deb to /output.
#   PAIRS deps (build order, supplied from /prebuilt): pairs_msgs pairs_lib pairs_modules_msgs
set -eo pipefail
ROS_DISTRO_NAME="noetic"; OS_NAME="ubuntu"; OS_VERSION="focal"
source "/opt/ros/${ROS_DISTRO_NAME}/setup.bash"
set -u

LOCAL_RULES="/src/pairs_serial/packaging/rosdep/pairs.yaml"
