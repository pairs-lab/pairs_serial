...
#include <pairs_modules_msgs/Gpgga.h>
#include <pairs_modules_msgs/Gpgsa.h>
#include <pairs_modules_msgs/Gpgst.h>
#include <pairs_modules_msgs/Gpvtg.h>

#include <pairs_msgs/StringStamped.h>

#include <pairs_modules_msgs/Bestpos.h>
#include <pairs_modules_msgs/GpsStatus.h>
...
private:
  ...
  pairs_modules_msgs::Bestpos bestpos_msg_;
...
void NmeaParser::onInit() {
  ...
  gpgga_pub_               = nh_.advertise<pairs_modules_msgs::Gpgga>("gpgga_out", 1);
  gpgsa_pub_               = nh_.advertise<pairs_modules_msgs::Gpgsa>("gpgsa_out", 1);
  gpgst_pub_               = nh_.advertise<pairs_modules_msgs::Gpgst>("gpgst_out", 1);
  gpvtg_pub_               = nh_.advertise<pairs_modules_msgs::Gpvtg>("gpvtg_out", 1);
  bestpos_pub_             = nh_.advertise<pairs_modules_msgs::Bestpos>("bestpos_out", 1);
  string_pub_              = nh_.advertise<std_msgs::String>("status_out", 1);
  string_raw_pub_          = nh_.advertise<pairs_msgs::StringStamped>("raw_out", 1);
...
void NmeaParser::processMessage() {
  ...
  pairs_msgs::StringStamped string_raw_out;
...
void NmeaParser::processGPGGA(std::vector<std::string>& results) {
  ...
  pairs_modules_msgs::Gpgga     gpgga_msg;
  pairs_modules_msgs::GpsStatus gps_status;
...
void NmeaParser::processGPGSA(std::vector<std::string>& results) {
  ...
  pairs_modules_msgs::Gpgsa gpgsa_msg;
...
void NmeaParser::processGPGST(std::vector<std::string>& results) {
  ...
  pairs_modules_msgs::Gpgst gpgst_msg;
...
void NmeaParser::processGPVTG(std::vector<std::string>& results) {
  ...
  pairs_modules_msgs::Gpvtg gpvtg_msg;
