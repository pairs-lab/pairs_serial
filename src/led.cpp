...
void Led::onInit() {
  ...
  /* baca_protocol_debug_publisher_ = nh_.advertise<pairs_modules_msgs::BacaProtocol>("baca_protocol_out_debug", 1); */
...
void Led::callbackSendRawMessage(const pairs_modules_msgs::SerialRawConstPtr &msg) {
