...
void BacaProtocol::callbackSendMessage(const pairs_modules_msgs::BacaProtocolConstPtr &msg) {
...
void BacaProtocol::callbackSendRawMessage(const pairs_modules_msgs::SerialRawConstPtr &msg) {
...
bool BacaProtocol::callbackSendInt([[maybe_unused]] pairs_msgs::SetInt::Request &req, pairs_msgs::SetInt::Response &res) {
...
bool BacaProtocol::callbackSendIntRaw([[maybe_unused]] pairs_msgs::SetInt::Request &req, pairs_msgs::SetInt::Response &res) {
