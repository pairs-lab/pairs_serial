...
private:
  ...
  pairs_lib::ServiceClientHandler<std_srvs::Trigger> service_eland_;
  pairs_lib::ServiceClientHandler<std_srvs::SetBool> service_set_leds_;
  pairs_lib::ServiceClientHandler<std_srvs::SetBool> service_set_ouster_;
  pairs_lib::ServiceClientHandler<std_srvs::SetBool> service_set_all_;
  ...
  void controlManagerCallback(const pairs_msgs::ControlManagerDiagnosticsConstPtr &msg);
...
void Estop::onInit() {
  ...
  pairs_lib::ParamLoader param_loader(nh_, "serial_estop");
  ...
  service_eland_      = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "eland_out");
  service_set_leds_   = pairs_lib::ServiceClientHandler<std_srvs::SetBool>(nh_, "set_leds_out");
  service_set_ouster_ = pairs_lib::ServiceClientHandler<std_srvs::SetBool>(nh_, "set_ouster_out");
  service_set_all_    = pairs_lib::ServiceClientHandler<std_srvs::SetBool>(nh_, "set_all_out");
...
void Estop::callbackSendRawMessage(const pairs_modules_msgs::SerialRawConstPtr &msg) {
...
void Estop::controlManagerCallback(const pairs_msgs::ControlManagerDiagnosticsConstPtr &msg) {
