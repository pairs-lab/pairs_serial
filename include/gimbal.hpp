...
#include <pairs_modules_msgs/GimbalPRY.h>

#include <dynamic_reconfigure/server.h>
#include "SBGC_lib/SBGC.h"
#include "serial_port.h"
#include <pairs_serial/gimbalConfig.h>
...
namespace gimbal {
    ...
    using Config = pairs_serial::gimbalConfig;
    ...
    private:
        ...
        void cmd_pry_cbk(const pairs_modules_msgs::GimbalPRY::ConstPtr &cmd_pry);
        ...
        void callbackDynamicReconfigure(const pairs_serial::gimbalConfig &config, const uint32_t level) {
        ...
        std::unique_ptr<pairs_lib::Transformer> m_transformer;
